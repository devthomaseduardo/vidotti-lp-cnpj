  ...
  return (
    <section id="empresas" className="relative overflow-hidden bg-[#0D1126] py-20 md:py-28">
      <div className="relative z-10 mx-auto max-w-[1280px] px-6">
        ...
        <div className="divide-y divide-white/10 border-y border-white/10 md:grid md:grid-cols-2 md:divide-x md:divide-y-0 lg:grid-cols-3">
          {services.map((s, i) => (
            <article
              key={s.title}
              data-reveal
              data-reveal-delay={i * 60}
              className="group flex min-h-[220px] flex-col px-0 py-7 transition-colors md:border-b md:border-white/10 md:px-8 lg:[&:nth-last-child(-n+3)]:border-b-0"
            >
        ...
        <div
          className="mt-14 overflow-hidden border-y border-white/10 py-8 md:mt-20 md:py-10"
          data-reveal
        >
          <div className="mb-6">
              ...
              {[...logos, ...logos].map((logo, i) => {
                ...
                return (
                  <div
                    ...
                    className="flex h-20 w-32 flex-shrink-0 items-center justify-center rounded-md bg-white p-3 md:h-32 md:w-52 md:p-5"
                  >
                    <img
                      src={logo}
        ...
        <div className="mt-10 grid grid-cols-2 gap-3 sm:flex sm:flex-wrap sm:gap-4" data-reveal>
          <a
            href="#lead-form"
            onClick={() =>
              trackConversionEvent("cta_clicked", {
                source: "services_primary",
          ...
          <WhatsAppLink
            source="services_whatsapp"
            intent="Quero falar com a Vidotti sobre o melhor serviço para minha empresa."
